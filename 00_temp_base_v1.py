...
class Converter:
    ...
    def help(self):
        ...
        get_help = Help(self)
        help_text = "To use this, enter in a temperature and then push a button."
    ...
    def __init__(self, partner, calc_history):
        ...
        if len(calc_history) >= 7:
            ...
            for item in calc_history:
                ...
                " history. You can use the export button to save this "
                "data to a text file if "
                "desired")
                

        #Label to display calculation history to user...
        self.calc_label = Label(self.history_frame, text=history_string, wrap=250, bg=background,font="Arial 12", justify=LEFT)
        ...
        #Export Button
        self.export_button = Button(self.export_dismiss_frame, text="Export", bg="white", font="Arial 12 bold", command=lambda: self.export(calc_history))
        self.export_button.grid(row=0, column=1)

        #Dismiss Button (row 2)
        self.dismiss_btn = Button(self.history_frame, text="Dismiss", width=10, bg="white", font="arial, 10 bold", command=partial(self.close_history, partner))
...
class Export():
    def __init__(self, partner, calc_history):
        ...
        #Error Message Labels (initiality blank, row 4)
